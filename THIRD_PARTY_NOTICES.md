...
| `app/vendor/yue2_abc.py` | [multimodal-art-projection/YuE](https://github.com/multimodal-art-projection/YuE) | Apache-2.0, see [`app/vendor/YuE-LICENSE`](app/vendor/YuE-LICENSE) |
...
at pinned revisions (see [MODELS.md](docs/MODELS.md)) and are licensed by their authors: YuE2-3B,
YuE2-Vae, SheetSage2, MERT-v2 and the Mothersuperior real-audio tokenizer are CC BY-NC 4.0. Each
community LoRA in [`config/lora-assets.json`](config/lora-assets.json) is licensed as stated on its model page.
