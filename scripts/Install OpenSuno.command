...
echo "OpenSuno dependencies are ready. Open scripts/Launch Studio.command, then open Models and download BF16. Cover analysis and Audio input are separate options."
